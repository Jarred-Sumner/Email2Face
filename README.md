...
After thinking about it for awhile, we came up with a good solution. Facebook has lots of faces, so why not use that? But, Facebook makes it near-impossible to search from their API. But, searching is pretty good as a human. Email2Face searches Facebook like a human. That's what this does. Email2Face signs into Facebook, does a [search by email](https://facebook.com/srch.php), and gives you a link to the first result's profile picture.
